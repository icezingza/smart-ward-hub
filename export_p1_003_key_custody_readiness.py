...
from p1_003_key_custody_readiness import SCHEMA_VERSION, TRACKS, template, template_sha256

ROOT = Path(__file__).resolve().parent
EVIDENCE_DIR = ROOT / "evals/micro_rag/evidence"
TEMPLATE_PATH = EVIDENCE_DIR / "p1-003-key-custody-readiness-template-20260820.json"
SCHEMA_PATH = EVIDENCE_DIR / "p1-003-key-custody-readiness-schema-v1.json"
...
def main() -> None:
    ...
    schema = {
        ...
        "$id": "https://smart-ward-hub.invalid/schema/p1-003-key-custody-readiness-v1",
        "title": "Smart Ward Hub P1-003 Key Custody Readiness",
        "type": "object",
        ...
        "properties": {
            ...
            "status": {"const": "KEY_CUSTODY_SOFTWARE_PREPARATION_READY"},
            "key_custody_execution": {"const": "NOT_STARTED"},
            "hardware_custody_validation": {"const": "UNVERIFIED"},
            ...
            "software_fixture_mode": {"const": "ALLOW_FOR_TESTS_ONLY_UNVERIFIED"},
            "no_private_key_material": {"const": True},
            "tracks": {"type": "object", "additionalProperties": False, "required": list(TRACKS), "description": "Exact KT-001 through KT-007 key-custody tracks; all require external evidence."},
            "common_controls": {"type": "object", "additionalProperties": False, "required": ["algorithm", "private_key_storage", "registry_material", "evidence_class", "production_credentials_present", "scope_ref", "window_ref", "rollback_ref", "custody_ref", "stop_rule"]},
