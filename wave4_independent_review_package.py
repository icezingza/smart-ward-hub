...
TEST_SPECS: dict[str, dict[str, Any]] = {
    ...
    "T-06": {"focus": "Freeze scope and governance binding", "evidence_class": "SOFTWARE_COORDINATION_ONLY", "refs": ("wave0-governance-checklist", "wave3-readiness-report", "release-freeze")},
...
ARTIFACT_PATHS: dict[str, str] = {
    ...
    "release-freeze": "evals/micro_rag/evidence/release-candidate-freeze-20260820.json",
