...
| Release-candidate freeze | `freeze_release_candidate.py` generated `evals/micro_rag/evidence/release-candidate-freeze-20260820.json` with `freeze_status=PASS` at source revision `58f8d60200ebe4bdbe0f87ed68965adefefc7a10`; publication commit is `67881520b2dfd05ba13f3f3b768ffb86c84c18bc`; manifest is repository/software evidence and excludes its own hash |
