...
| Release-candidate freeze | `freeze_release_candidate.py` generated `evals/micro_rag/evidence/release-candidate-freeze-20260820.json` with `freeze_status=PASS` at source revision `0da6a381e4004ea31537383a351bce9846418ec1`; manifest publication commit is `29ace50a588c2bf258c29153fdb563c808fd93b6`; manifest is repository/software evidence, excludes its own hash and freezes the preceding source revision |
