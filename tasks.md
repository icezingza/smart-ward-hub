...
| P2-004 | In Progress | Current live samples are insufficient; Gemini 2.5 is 0/8 provider-limited and Gemini 3 is 6/8 with two provider 429; runtime readiness preflight is NOT_READY | Repeat each pinned model in an appropriate provider window, obtain at least two compatible samples, then complete external persistence owner/retention/access review and runtime semantic-index evaluation |
