...
SOFTWARE_DOMAINS = (
    SimulationDomain("SIM-001", "Smart Watch telemetry contract, ward scale and replay handling", ("test_smartwatch_simulator.py", "test_ward_scale_simulation.py", "test_p2_edge_iot_adapters.py"), "30/40-bed synthetic ward, normal, fall, vital anomaly, replay, out-of-order, disconnect/reconnect, malformed envelope, PII and command rejection", "does not prove sensor accuracy, BLE radio, firmware, battery, wearer safety, blood pressure, or geofence coverage"),
    ...
    SimulationDomain("SIM-008", "HIS/FHIR and downstream failure handling", ("test_fhir.py", "test_p0_his_admission_contract.py", "test_hospital_full_system_simulation.py", "test_p0_his_fhir_contract_readiness_guard.py"), "opaque token boundary, multi-ward FastAPI flow, structured acknowledgement, mismatch, timeout and retention behavior", "does not prove real HIS endpoint, hospital authorization, certificate interoperability, or live data mapping"),
