"""Export a redacted local snapshot of the aggregate pre-handoff gate."""
...
def export_reconciliation(output: Path | None = None, project_root: Path = ROOT) -> dict:
    ...
    evidence = {
        ...
        "child_decisions": result["child_decisions"],
...
if __name__ == "__main__":
    destination = ROOT / "evals" / "micro_rag" / "evidence" / "pre-handoff-reconciliation-gate-local.json"
    export_reconciliation(output=destination)
    print(destination)
